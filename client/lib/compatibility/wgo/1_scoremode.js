...
ScoreMode.prototype.displayScore = function(drawScore) {
	var score = {
		black: [],
		white: [],
		neutral: [],
	...
	if (this.old_score) {
		this.board.removeObject(this.old_score.white_captured);
		this.board.removeObject(this.old_score.black_captured);
		this.board.removeObject(this.old_score.black);
		this.board.removeObject(this.old_score.white);
	}
	if (drawScore) {
...
WGo.i18n.en["bwin"] = "Black is winning by $ points";
WGo.i18n.en["wwin"] = "White is winning by $ points";
